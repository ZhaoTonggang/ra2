...
ra2webInjection.translationMap = {
	...
	'Ladder Season 2 is live. Play a "Quick Match" and get your rank badge now! ': "这里是自定义房间大厅，你也可以从主菜单的‘快速匹配’选项来开启排位赛征程并获得徽章！现在天梯第二赛季已经开赛，尽情挑战吧！游玩人机请返回主菜单并选择 单机模式",
	"Join us on Discord: https://discord.gg/uavJ34JTWY": "感谢大家支持，本站为非营利站点，纯属兴趣爱好",
	...
	"Main Menu": "主菜单",
	"https://openai.weixin.qq.com/webapp/NlFdeGGV6J4GfwxPImLX9mxGXzkSHg?robotName=%E7%BA%A2%E8%89%B2%E8%AD%A6%E6%88%922%E7%BD%91%E9%A1%B5%E7%89%88": "dom-node:discordlink",
	"Quick Match": "排位赛",
	"Custom Match": "自定义房间",
	"Demo Mode": "单机模式",
	Replays: "回放",
...
ra2webInjection.transDOMMap = {
	"dom-node:discordlink": `<p style="color: red;font-weight: bold;">点击反馈问题</p>`,
	"dom-node:快速匹配": `排位赛`,
};
	...
	var s = (function(e) {
		...
		n = {
			...
			android: {
				...
				device: (!s(l9e) && (s(o9e) || s(a9e) || s(r9e) || s(i9e))) ||
					s(/\bokhttp\b/i),
			},
			windows: {
				phone: s(l9e),
...
var [customHDownEvent, customHUpEvent] = createCustomLetterButtonEvents("h"),
	...
	customSpaceDownEvent = new CustomEvent(Ra2webGameKeyboardDownEvent, {
		detail: {
			keyboardEvent: keyboardSpaceDownEvent
		},
	}),
	customSpaceUpEvent = new CustomEvent(Ra2webGameKeyboardUpEvent, {
		detail: {
			keyboardEvent: keyboardSpaceUpEvent
		},
	});
...
const monitorTargetSite = "https://other.heheda.top/ra2/";
